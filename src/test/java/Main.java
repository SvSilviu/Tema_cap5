...
//          Link4 ();
    ...
    public static void Link1 () {
        ...
        WebElement explicatieSite = driver.findElement (By.cssSelector ("div.explanation"));
        System.out.println (explicatieSite.getText ());

        WebElement paragraf1 = driver.findElement (By.cssSelector ("p#para1.main"));
        System.out.println (paragraf1.getText ());

        WebElement paragraf2 = driver.findElement (By.cssSelector ("p#para2.sub"));
        System.out.println (paragraf2.getText ());
    ...
    public static void Link4() {
     ...
     /*   List<WebElement> randuriTabel = driver.findElements (By.cssSelector ("#tablehere table tr"));
        for (int i = 0; i< randuriTabel.size (); i++){
            WebElement currentRow = randuriTabel.get (1);
            if(i == 0){
        ...
        List<WebElement> randuriTabel = driver.findElements (By.cssSelector ("#tablehere table tr"));
        WebElement rand1 = randuriTabel.get (0);
        List<WebElement> coloana1 = rand1.findElements (By.cssSelector ("th"));
        System.out.println ("Header din prima coloana:" + coloana1.get (0).getText ());
        System.out.println ("Header din a doua coloana:" + coloana1.get (1).getText ());
        System.out.println ("");


        WebElement rand2 = randuriTabel.get (1);
        List<WebElement> coloana2 = rand2.findElements (By.cssSelector ("td"));
        System.out.println ("Text din randul 2, coloana 1:" + coloana2.get (0).getText ());
        System.out.println ("Text din randul 2, coloana 2:" + coloana2.get (1).getText ());

        WebElement rand3 = randuriTabel.get (2);
        List<WebElement> coloana3 = rand3.findElements (By.cssSelector ("td"));
        System.out.println ("Text din randul 3, coloana 1:" + coloana3.get (0).getText ());
        System.out.println ("Text din randul 3, coloana 2:" + coloana3.get (1).getText ());

        WebElement rand4 = randuriTabel.get (3);
        List<WebElement> coloana4 = rand4.findElements (By.cssSelector ("td"));
        System.out.println ("Text din randul 4, coloana 1:" + coloana4.get (0).getText ());
        System.out.println ("Text din randul 4, coloana 2:" + coloana4.get (1).getText ());

        WebElement rand5 = randuriTabel.get (4);
        List<WebElement> coloana5 = rand5.findElements (By.cssSelector ("td"));
        System.out.println ("Text din randul 5, coloana 1:" + coloana5.get (0).getText ());
        System.out.println ("Text din randul 5, coloana 2:" + coloana5.get (1).getText ());
